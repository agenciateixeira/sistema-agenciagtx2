...
VALUES (
  'avatars',
  'avatars',
  true,  -- Público para que as imagens possam ser acessadas via URL
  2097152,  -- 2MB limit
...
-- Política: Qualquer usuário autenticado pode deletar seu próprio avatar
...
-- Política: Todos podem ver avatares (bucket público)
